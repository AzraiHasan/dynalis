// Simplified demo session composable
...
export const useDemoSession = () => {
  ...
  const initializeSession = () => {
    ...
    const existingDemo = localStorage.getItem('demo_mode')
    const existingStartTime = localStorage.getItem('demo_start_time')
  ...
  const startSession = () => {
    ...
    localStorage.setItem('demo_start_time', now.toString())
